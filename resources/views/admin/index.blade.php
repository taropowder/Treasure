        ...
        <div class="ps-section__header mb-50">
            <div class="row">
                <div class="col-lg-9 col-md-9 col-sm-12 col-xs-12 ">
                    <h3 class="ps-section__title" data-mask="ABOUT">&nbsp;&nbsp; WELCOME TO NEV</h3>
                </div>
            </div>
        </div>
...
<div class="ps-section--offer">
    <div class="ps-section__header mb-50">
        <div class="row">
            <div class="col-lg-9 col-md-9 col-sm-12 col-xs-12 ">
                <h3 class="ps-section__title" data-mask="STORES">&nbsp;&nbsp; -news</h3>
            </div>
        </div>
    </div>
    <div class="ps-column" style="padding: 2rem;padding-bottom:0"><a  href=""><img width="90%" height="60%" src="/images/index/001.jpg" alt=""></a>
    ...
    <div class="ps-column" style="padding: 2rem;padding-bottom: 0"><a  href=""><img width="90%" height="60%"  src="/images/index/002.jpg" alt=""></a>
    <p>XEV has developed industrial 3D printing technologies and processes for automotive mass production.
        We use 3D printing to give our customers an ultimate user experience through fast product development,
        customization and flexibility of design.
    </p></div>
    ...
    <div class="ps-column" style="padding: 2rem;padding-bottom: 0;margin-top: -5rem;margin-bottom: -6.5rem"><a  href=""><img width="90%" height="60%"  src="/images/index/003.jpg" alt=""></a>
    ...
    <div class="ps-column" style="padding: 2rem;padding-bottom: 0;margin-top: -5rem;margin-bottom: -6.5rem"><a  href=""><img width="90%" height="60%"  src="/images/index/004.jpg" alt=""></a>
